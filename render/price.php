<div class="price_table_1 mag-icon-wrap <?php echo $className; ?>" style="background-color: <?php echo $price_bg; ?>; box-shadow: 0 0 9px rgba(0,0,0,0.5), 0 -3px 0px <?php echo $top_bg; ?> inset;">
	...
	<div class="plan">
		...
		<div class="content" style="color: <?php echo $feature_clr; ?>;">
			<?php echo $content; ?>
		</div>			
		<div class="price">
      		<a href="<?php echo $btn_url; ?>" target="<?php echo $link_target; ?>" class="price-btn" style="font-size: <?php echo $btnsize; ?>px; background-color: <?php echo $top_bg; ?>; box-shadow: inset 0 -2px <?php echo $top_bg; ?>;-webkit-box-shadow: inset 0 -2px <?php echo $top_bg; ?>;">
      			<?php echo $btn_text; ?>
      		</a>
		</div>
	</div>
