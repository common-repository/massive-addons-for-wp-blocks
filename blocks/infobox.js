...
( function( blocks, i18n, element ) {
	 ...
	 */
	blocks.registerBlockType( 'nasir-blocks-gutenberg/infobox', {
		title: __( 'Info Box' ),
	    ...
	    description: __( 'Add icon box with custom font icon' ),
		attributes: {
	        info_style: {
	            type: 'string',
			...
			image_id: {
				type: 'string',
				default: nbg_vars.nbg_assets_dir+'/images/user.jpg'
			},
			image_width: {
				type: 'string',
				default: '',
			...
			content: {
				type: 'string',
				default: 'Write a short description for info box.',
			},
		},
	    edit: function(props) {
	        ...
	        return [!!props.isSelected && el(
				    ...
				    el( PanelBody, {
						...
						el(
	                        SelectControl, {
	                            ...
	                            value: props.attributes.info_style,
	                            options: [
	                            	{label: __('Vertical'), 	value: 'mega_info_box'},
	                            	{label: __('Horizental'), 	value: 'mega_info_box_2'},
	                            ],
						...
						el(
		                    TextControl, {
		                        type: 'number',
		                        label: __('Box Padding [Top Bottom]px'),
		                        help: __('It will increase the info box height'),
		                        value: props.attributes.count_box_height,
		                        onChange: function(value) {
		                            props.setAttributes({
		                                count_box_height: value
		                            });
		                        },
		                    }
		                ),
		                el(
		                    TextControl, {
		                        type: 'number',
		                        label: __('Box Padding [Right Left]px'),
		                        help: __('It will increase the info box width'),
		                        value: props.attributes.count_box_width,
		                        onChange: function(value) {
		                            props.setAttributes({
		                                count_box_width: value
		                            });
		                        },
		                    }
		                ),
		                el(
		                    TextControl, {
		                        ...
		                        value: props.attributes.box_border_width,
		                        onChange: function(value) {
		                            props.setAttributes({
		                                box_border_width: value
		                            });
		                        },
		                    }
		                ),
		                [!! (props.attributes.box_border_width != '') && el(
	                        SelectControl, {
		                ...
		                el(
		                    TextControl, {
		                        ...
		                        value: props.attributes.box_border_radius,
		                        onChange: function(value) {
		                            props.setAttributes({
		                                box_border_radius: value
		                            });
		                        },
		                    }
		                ),
		                el(
	                        SelectControl, {
	                            ...
	                            options: [
	                            	...
	                            	{label: __('Complete Box'), 	value: 'link_box'},
	                            	{label: __('Read More'), 		value: 'link_btn'},
	                            ],
	                    ...
	                    [!! (props.attributes.link == 'link_btn') && el(
		                    TextControl, {
		                        type: 'text',
		                ...
		                el(
	                        SelectControl, {
	                            ...
	                            options: [
	                            	{label: __('None'), 			value: 'none'},
	                            	{label: __('Box Shadow'), 	value: 'vc_info_box_shadow'},
	                            ],
	                    ...
	                    [!! (props.attributes.link == 'link_box' || props.attributes.link == 'link_btn') && el(
		                    TextControl, {
		                        label: __('Button Url'),
		                ...
		                el(
		                    PanelColorSettings, {
			                    ...
			                    },
			                    {
			                        ...
			                        value: props.attributes.box_border_clr,
			                        onChange: function(value) {
			                            props.setAttributes({
			                                box_border_clr: value
			                            });
			                        },
			                    },
		                		{
			                        label: __( 'Background Color' ),
			                        value: props.attributes.box_bg,
			                        onChange: function(value) {
			                            props.setAttributes({
			                                box_bg: value
			                            });
					...
					el( PanelBody, {
					    ...
					    el(
	                        SelectControl, {
	                            ...
	                            options: [
	                            	...
	                            	{label: __('Font Icon'), 	value: 'icon'},
	                            ],
	                            value: props.attributes.sec_style,
	                            onChange: function(value) {
	                                props.setAttributes({
	                                    sec_style: value
	                                });
	                    ...
	                    [!! (props.attributes.sec_style == 'image') && el(
		                    TextControl, {
		                        type: 'text',
		                ...
		                [!! (props.attributes.sec_style == 'image') && el(
		                    TextControl, {
		                        type: 'number',
		                        label: __('Image Radius (px)'),
		                        help: __('It will make round the image from edges on incresing value.'),
		                ...
		                [!! (props.attributes.sec_style == 'icon') && el('div', {className: 'mbg-font-picker-wrap mag-icon-wrap'},
							el(
			                    SelectControl, {
			                        options: icons_array,
					    ...
					    [!! (props.attributes.sec_style == 'icon') && el(
		                    TextControl, {
		                        type: 'number',
		                ...
		                [!! (props.attributes.sec_style == 'icon') && el(
		                    TextControl, {
		                        type: 'number',
		                        label: __('Height/Width'),
		                        help: __('height & width for icon, set in pixel.'),
		                        value: props.attributes.icon_height,
		                        onChange: function(value) {
		                            props.setAttributes({
		                                icon_height: value
		                            });
		                ...
		                [!! (props.attributes.sec_style == 'icon') && el(
		                    TextControl, {
		                        type: 'number',
		                        label: __('Border Width (px)'),
		                        value: props.attributes.icon_border_width,
		                        onChange: function(value) {
		                            props.setAttributes({
		                                icon_border_width: value
		                            });
		                        },
		                    }
		                ),
		                ...
		                [!! (props.attributes.sec_style == 'icon') && el(
	                        SelectControl, {
	                            ...
	                            value: props.attributes.icon_border_style,
	                            onChange: function(value) {
	                                props.setAttributes({
		                ...
		                [!! (props.attributes.sec_style == 'icon') && el(
		                    TextControl, {
		                        type: 'number',
		                        label: __('Border Radius (px)'),
		                        value: props.attributes.icon_border_radius,
		                        onChange: function(value) {
		                            props.setAttributes({
		                                icon_border_radius: value
		                            });
		                        },
		                    }
		                ),
		                ...
		                [!! (props.attributes.sec_style == 'icon') && el(
		                    PanelColorSettings, {
			                    ...
			                    {
			                        label: __( 'Border Color' ),
			                        value: props.attributes.border_clr,
			                        onChange: function(value) {
			                            props.setAttributes({
			                                border_clr: value
			                            });
					...
					el( PanelBody, {
						...
						el(
		                    TextControl, {
		                        ...
		                        help: __('gap between title & description'),
		                        value: props.attributes.line_height,
		                        onChange: function(value) {
		                            props.setAttributes({
		                                line_height: value
		                            });
	            ...
	            el(
					...
					{},
			       	el(
						'div',
						{ class: props.attributes.info_style+' '+props.attributes.shadow+' mag-icon-wrap mega-info-box-'+some_id+'', style: {
						'border-radius':props.attributes.box_border_radius+'px',
						'background':props.attributes.box_bg,
						'border':props.attributes.box_border_width+'px '+props.attributes.border_style+' '+props.attributes.box_border_clr,
						'padding':props.attributes.count_box_height+'px '+props.attributes.count_box_width+'px',
			        	},},
				        el(
							'div',
							{ class: 'mega-info-header'},
					        [!! (props.attributes.sec_style == 'image') && el(
								'img',
								{ src: props.attributes.image_id, style:{
			            			'width':props.attributes.image_width+'px',
			            			'border-radius':props.attributes.image_radius+'px',
			            		},},
							)
							],
					        [!! (props.attributes.sec_style == 'icon') && el(
							'i',
								{ className: props.attributes.icon_class, style: {
									'font-size':props.attributes.icon_size+'px',
									'color':props.attributes.icon_color,
									'background':props.attributes.icon_bg,
									'border':props.attributes.icon_border_width+'px '+props.attributes.icon_border_style+' '+props.attributes.border_clr,
									'border-radius':props.attributes.icon_border_radius+'px',
									'width':props.attributes.icon_height+'px',
									'height':props.attributes.icon_height+'px',
									'line-height':props.attributes.icon_height-props.attributes.icon_border_width*2+'px',
				        		},},
							)
							],
						),
							...
							'div',
				        		...
				        		el(
					                RichText,
					                {
					                    ...
					                    tagName: 'div',
					                    className: '',
					                    style: {'color': props.attributes.desc_color, 'font-size': props.attributes.desc_size+'px' },
				...
				el('style', 
	            	null,
	            	'.mega-info-box-'+some_id+':hover .mega-info-header i {color: '+props.attributes.hoverclr+' !important; background: '+props.attributes.hoverbg+' !important;}',
	            ),
	        ];
	    },
		save: function(props) {
