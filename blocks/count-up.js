...
( function( blocks, i18n, element ) {
	 ...
	 */
	blocks.registerBlockType( 'nasir-blocks-gutenberg/count-up', {
		...
		attributes: {
	        ...
	        image_id: {
	            type: 'string',
	            default: nbg_vars.nbg_assets_dir+'/images/7cntr.png'
	        },
	        image_width: {
	            type: 'string',
	            default: '90'
	        ...
	        return [!!props.isSelected && el(
	                ...
	                el( PanelBody, {
						...
						el(
	                        SelectControl, {
	                            ...
	                            value: props.attributes.counter_style,
	                            options: [
	                            	{label: __('Top logo bottom content'), 		value: 'style'},
	                            	{label: __('Top logo bottom content 2'), 	value: 'style2'},
	                            	{label: __('Left logo right content'), 		value: 'style3'},
	                            	{label: __('Left content right logo'), 		value: 'style4'},
	                            	{label: __('Logo in center'),		 		value: 'style5'},
	                            ],
						...
						el(
		                    TextControl, {
		                        ...
		                        help: __('It will increase the counter box height'),
		                ...
		                el(
		                    TextControl, {
		                        ...
		                        help: __('It will increase the counter box width'),
					...
					el( PanelBody, {
					    ...
					    el(
		                    TextControl, {
		                        label: __('Title'),
		                        value: props.attributes.count_title,
		                        onChange: function(value) {
		                            props.setAttributes({
		                                count_title: value,
		                            });
				    ...
				    el( PanelBody, {
	                    ...
	                    el(
		                    TextControl, {
		                        label: __('After Text'),
		                        value: props.attributes.text_after,
		                        onChange: function(value) {
		                            props.setAttributes({
		                                text_after: value,
		                            });
						...
						el(
		                    FontSizePicker,
		                    {
		                        value: props.attributes.stat_size,
		                        label: __('Font Size'),
		                        onChange: function(value) {
		                            props.setAttributes({
		                                stat_size: value,
	                ...
	                el(
	                    PanelColorSettings, {
	                        ...
	                        initialOpen: false,
	                        colorSettings: [{
		                        value: props.attributes.icon_clr,
	                        	label: __( 'Icon Color' ),
		                        onChange: function(value) {
		                            props.setAttributes({
		                                icon_clr: value
	            ...
	            [!! (props.attributes.counter_style == 'style') && el(
					'div',
					{ id: 'mega_count_bar', className: 'mag-icon-wrap', style: {
						...
						'padding':props.attributes.count_box_height+'px '+ props.attributes.count_box_height+'px',
			        },},
			        el(
						'div',
							{ class: 'mega_count_img' },
							[!! (props.attributes.sec_style == 'image') && el(
								'img',
							...
							'i',
								{ className: props.attributes.icon_class, style: {
									...
									'color':props.attributes.icon_clr,
				        		},},
							)
							],
					),
					el(
						'div',
							{ class: 'mega_count_content', style: {
								'text-align': 'center',
							},},
							el(
								'span', 
								{className: 'main-counter', style: {
				        			color: props.attributes.number_color,
				        			'line-height': props.attributes.lineheight,
				        			'font-size': props.attributes.stat_size+'px',
				        		},}, 
				        		props.attributes.counter_content
				        	),
				        	el(
				        		'span', {className: 'counter-after', style: {
				        			color: props.attributes.number_color,
				        			'font-size': props.attributes.stat_size+'px',
				        		},}, 
				        		props.attributes.text_after
				        	),
				        	el(
				        		'h3', {style: {
				        			'font-size': props.attributes.title_size+'px',
				        			'color': props.attributes.text_color,
				        			'font-family': props.attributes.font_family,
				        			'margin': '0',
				        		},}, 
				        		props.attributes.count_title
				        	),
					),
				)
				],

				[!! (props.attributes.counter_style == 'style2') && el(
					'div',
					{ id: 'mega_count_bar', className: 'mag-icon-wrap', style: {
						'border-radius':props.attributes.box_border_radius+'px',
						'background':props.attributes.box_bg,
					...
					el(
						'div',
				        	...
				        	el(
				        		'hr', {style: {
				        			'line-height': props.attributes.lineheight,
				        			'margin': props.attributes.lineheight+'px auto',
				...
				[!! (props.attributes.counter_style == 'style3') && el(
					'div',
					{ id: 'mega_count_bar_2', className: 'mag-icon-wrap', style: {
						'border-radius':props.attributes.box_border_radius+'px',
						'background':props.attributes.box_bg,
						'border':props.attributes.box_border_width+'px '+props.attributes.border_style+' '+props.attributes.box_border_clr,
						'padding':props.attributes.count_box_height+'px '+ props.attributes.count_box_height+'px',
				...
				[!! (props.attributes.counter_style == 'style4') && el(
					'div',
					{ id: 'mega_count_bar_3', className: 'mag-icon-wrap', style: {
						'border-radius':props.attributes.box_border_radius+'px',
						'background':props.attributes.box_bg,
						'border':props.attributes.box_border_width+'px '+props.attributes.border_style+' '+props.attributes.box_border_clr,
						'padding':props.attributes.count_box_height+'px '+ props.attributes.count_box_height+'px',
				...
				[!! (props.attributes.counter_style == 'style5') && el(
					'div',
					{ id: 'mega_count_bar_4', className: 'mag-icon-wrap', style: {
						'border-radius':props.attributes.box_border_radius+'px',
						'background':props.attributes.box_bg,
						'border':props.attributes.box_border_width+'px '+props.attributes.border_style+' '+props.attributes.box_border_clr,
						'padding':props.attributes.count_box_height+'px '+ props.attributes.count_box_height+'px',
